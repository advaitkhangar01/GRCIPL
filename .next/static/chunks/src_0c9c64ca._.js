(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_0c9c64ca._.js", {
...
async function fetchUnassignedLeads() {
    ...
    // Filter mock data for unassigned leads
    const allLeads = [
        {
            id: 1,
...
function AssignLeadsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AssignLeadsPage.useEffect": ()=>{
            const loadData = {
                "AssignLeadsPage.useEffect.loadData": async ()=>{
                    setIsLoading(true);
                    try {
            ...
            }["AssignLeadsPage.useEffect.loadData"];
            loadData();
        }
    }["AssignLeadsPage.useEffect"], [
        toast
    ...
    const handleAssign = async ()=>{
        ...
        try {
            ...
            if (result.success) {
                ...
                const updatedLeads = await fetchUnassignedLeads();
...
_s(AssignLeadsPage, "cFd3OWCmgM6Sw3MmN7pS5i+mVog=", false, function() {
    return [
...
//# sourceMappingURL=src_0c9c64ca._.js.map